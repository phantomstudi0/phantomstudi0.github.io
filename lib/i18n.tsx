...
export const STRINGS = {
  ru: {
    ...
    'proj.more':      'Подробнее →',
    'proj.viewAll':   'Смотреть все работы',
    'proj.allTitle':  'Все проекты',
    'proj.allSub':    'Полный каталог наших работ — от лендингов до production-SaaS',
    'proj.backHome':  '← На главную',
    'proj.noMatch':   'В этой категории пока нет проектов',
    'proj.about':     'О проекте',
    'proj.results':   'Результат',
    'proj.stack':     'Стек технологий',
    'proj.want':      'Хочу такое же →',
    'proj.demo':      'Смотреть демо ↗',
    'proj.live':      'Открыть сайт ↗',
    'proj.close':     'Закрыть',
    ...
    'team.label':     'Команда',
    'team.title':     'Кто мы',
    'team.subtitle':  'Опытная команда разработчиков, от 4 лет в IT. Работаем удалённо.',
    ...
    'fl.label':    'Фриланс-профили',
    'fl.title':    'Найдите нас',
    'fl.subtitle': 'Работаем через проверенные платформы — безопасная сделка и защита для обеих сторон',
    'fl.active':   'Активен',
    'fl.soon':     'Скоро',
    'fl.visit':    'Открыть профиль →',
  },
  en: {
    ...
    'proj.allTitle':  'All projects',
    'proj.allSub':    'Complete catalog of our work — from landings to production SaaS',
    'proj.backHome':  '← Back home',
    'proj.noMatch':   'No projects in this category yet',
    ...
    'team.subtitle':  'Experienced developers, 4+ years in tech. We work remotely worldwide.',
    ...
    'fl.label':    'Freelance Profiles',
    'fl.title':    'Find Us',
    'fl.subtitle': 'We work through trusted platforms — secure transactions and protection for both sides',
    'fl.active':   'Active',
    'fl.soon':     'Coming Soon',
    'fl.visit':    'View Profile →',
  },
} as const
